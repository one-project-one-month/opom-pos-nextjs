...
import {
  ...
  OutOfStocksSvg,
  TotalProductsSvg,
} from "@/app/components/custom-svg";
...
import {
  useCreateProduct,
  useDeletProduct,
  useFetchManagerProducts,
  useFetchProducts,
} from "@/app/hooks/useFetchProduct";
import {
  CategoriesResponse,
  Product,
  ProductsResponse,
  ...
  return (
    <>
          ...
          >
            ...
            <div>
              ...
              <p className="font-semibold text-lg">
                {isLoading ? <LoaderIcon /> : product.count}
              </p>
            </div>
          </div>
        ))}
      ...
      <div className="grid md:grid-cols-5 sm:grid-cols-3 gap-2">
        ...
        {categoriesError && (
          <p className="text-alert-400">Error loading categories</p>
        )}
