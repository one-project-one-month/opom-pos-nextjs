...
const Page = () => {
  ...
  return (
    <div className='p-5'>
      ...
      {
        suspendModal &&
        <Modal onClose={() => setSuspendModal(false)} className="bg-white p-6 rounded-2xl shadow-xl w-full max-w-sm mx-auto">
          <ModalTitle>Suspend Confirmation</ModalTitle>
          <span className='text-center'>Are you sure to suspend this staff?</span>
          <div className='flex justify-center gap-2 mt-5'>
            <CustomBtn className="border border-alert-400 hover:bg-alert-500 hover:text-white text-black" onClick={() => setSuspendModal(false)}>No</CustomBtn>
      ...
      {
        unsuspendModal &&
        <Modal onClose={() => setUnsuspendModal(false)} className="bg-white p-6 rounded-2xl shadow-xl w-full max-w-sm mx-auto">
          <ModalTitle>Unsuspend Confirmation</ModalTitle>
          <span className='text-center'>Are you sure to unsuspend this staff?</span>
          <div className='flex justify-center gap-2 mt-5'>
